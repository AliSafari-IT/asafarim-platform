 ...
 *
 * Removes the image from this album.
 * Does NOT delete the source ViontoAsset or its storage object.
 * Removing from the base album is only allowed via the project-level asset delete.
 */
