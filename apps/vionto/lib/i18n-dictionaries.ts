...
export const viontoDictionaries: Dictionaries = {
  en: {
    ...
    "vionto.subtitlePreset.minimal_clean.description": "Simple white text with thin outline",
    "vionto.subtitlePreset.cinematic_lower_third": "Cinematic",
    "vionto.subtitlePreset.cinematic_lower_third.description": "Elegant lower-third with semi-transparent background",
    "vionto.subtitlePreset.social_bold": "Social Bold",
    "vionto.subtitlePreset.social_bold.description": "Large centered bold text for social media",
    "vionto.subtitlePreset.documentary": "Documentary",
    "vionto.subtitlePreset.documentary.description": "Clean captions with dark background box",
    "vionto.subtitlePreset.high_contrast": "High Contrast",
    "vionto.subtitlePreset.high_contrast.description": "Yellow text on black background for accessibility",
    "vionto.subtitlePreset.elegant_memory": "Elegant Memory",
    "vionto.subtitlePreset.elegant_memory.description": "Warm serif font with subtle background",
    ...
    "vionto.visualStyle.film_grain.description": "Textured grain, soft contrast, and memory-film atmosphere.",
    "vionto.visualStyle.polaroid_memory": "Polaroid memory",
    "vionto.visualStyle.polaroid_memory.description": "Warm tones, gentle vignette, and nostalgic photo-album treatment.",
    "vionto.visualStyle.clean_modern_slideshow": "Clean modern slideshow",
    "vionto.visualStyle.clean_modern_slideshow.description": "Sharp, neutral, minimal rendering with the current default look.",
    "vionto.visualStyle.travel_map_overlay": "Travel map overlay",
    "vionto.visualStyle.travel_map_overlay.description": "Brighter travel color with a subtle map-grid overlay.",
    "vionto.visualStyle.vhs_archive": "VHS/archive look",
    "vionto.visualStyle.vhs_archive.description": "Muted color, analog noise, and archival edge treatment.",
    "vionto.visualStyle.wedding_cinematic": "Wedding cinematic",
    "vionto.visualStyle.wedding_cinematic.description": "Soft cinematic contrast, vignette, and elegant caption typography.",
    "vionto.visualStyle.social_vertical_captions": "Social vertical captions",
    "vionto.visualStyle.social_vertical_captions.description": "High-contrast vertical-friendly framing with bold centered captions.",
    ...
    "vionto.projects.description": "Manage your video projects. Create new ones, rename or delete existing ones, or share them with teammates.",
    ...
    "vionto.projects.emptyDescription": "Create your first project to get started.",
    ...
    "vionto.projects.deleteOutro": "and all its assets, scripts, and exports. This action cannot be undone.",
    ...
    "vionto.projects.sharePending": "{email} is not registered yet. They'll get access when they sign up.",
    ...
    "vionto.downloadDialog.description": "Your video is ready. Copy the download link below to share, or download directly.",
    ...
    "vionto.music.cinematic_strings.description": "Dramatic orchestra/string tracks for epic, documentary, and milestone videos.",
    ...
    "vionto.music.family_warm_acoustic.description": "Soft acoustic tracks for family archives, birthdays, and personal memories.",
    "vionto.music.happy_upbeat": "Happy upbeat",
    "vionto.music.happy_upbeat.description": "Joyful, energetic tracks for celebrations and happy moments.",
    "vionto.music.no_music": "No music",
    "vionto.music.no_music.description": "Narration-only videos without background music.",
    "vionto.music.upload_own": "Upload own music",
    "vionto.music.upload_own.description": "Provide your own audio file if you have the rights to use it.",
    "vionto.music.uploading": "Uploading music...",
    "vionto.music.uploadDisclaimer": "By uploading music, you confirm that you have the rights to use it in your video.",
    ...
    "vionto.music.libraryEmptyHint": "Upload your first track in the Upload tab.",
    "vionto.music.libraryArtist": "Your library",
    "vionto.music.commonArtist": "Common library",
    "vionto.music.commonBadge": "Shared",
  ...
  nl: {
    ...
    "vionto.emotionalTone.funny.description": "Licht, speels, witty vertelling voor casual albums en sociale bewerkingen.",
    "vionto.emotionalTone.romantic": "Romantisch",
    "vionto.emotionalTone.romantic.description": "Teder, intiem, affectieve toon voor koppels, bruiloften, anniversaries, en liefdesverhalen.",
    ...
    "vionto.visualStyle.film_grain.description": "Textuurkorrel, zacht contrast en herinneringsfilm-atmosfeer.",
    "vionto.visualStyle.polaroid_memory": "Polaroid-herinnering",
    "vionto.visualStyle.polaroid_memory.description": "Warme tinten, zachte vignette en nostalgische fotoalbumstijl.",
    "vionto.visualStyle.clean_modern_slideshow": "Strakke moderne slideshow",
    "vionto.visualStyle.clean_modern_slideshow.description": "Scherpe, neutrale, minimale rendering met de huidige standaardlook.",
    "vionto.visualStyle.travel_map_overlay": "Reiskaart-overlay",
    "vionto.visualStyle.travel_map_overlay.description": "Helderdere reiskleur met een subtiele kaartgrid-overlay.",
    "vionto.visualStyle.vhs_archive": "VHS/archief-look",
    "vionto.visualStyle.vhs_archive.description": "Gedempte kleur, analoge ruis en archiefachtige randbehandeling.",
    "vionto.visualStyle.wedding_cinematic": "Bruiloft cinematografisch",
    "vionto.visualStyle.wedding_cinematic.description": "Zacht filmisch contrast, vignette en elegante ondertitelingstypografie.",
    "vionto.visualStyle.social_vertical_captions": "Social verticale captions",
    "vionto.visualStyle.social_vertical_captions.description": "Contrastrijke verticale framing met vet gecentreerde captions.",
    ...
    "vionto.projects.description": "Beheer je videoprojecten. Maak nieuwe projecten, hernoem of verwijder bestaande projecten, of deel ze met teamgenoten.",
    ...
    "vionto.projects.emptyDescription": "Maak je eerste project om te beginnen.",
    ...
    "vionto.projects.deleteOutro": "en alle bestanden, scripts en exports. Deze actie kan niet ongedaan worden gemaakt.",
    "vionto.projects.assetWillBeRemoved": "{count} bestand wordt verwijderd.",
    "vionto.projects.assetsWillBeRemoved": "{count} bestanden worden verwijderd.",
    ...
    "vionto.projects.sharePending": "{email} is nog niet geregistreerd. Ze krijgen toegang zodra ze zich registreren.",
    ...
    "vionto.music.libraryEmptyHint": "Upload je eerste track in het tabblad Upload.",
    "vionto.music.libraryArtist": "Jouw bibliotheek",
    "vionto.music.commonArtist": "Gemeenschappelijke bibliotheek",
    "vionto.music.commonBadge": "Gedeeld",
  ...
  fr: {
    ...
    "vionto.visualStyle.film_grain.description": "Grain texturé, contraste doux et atmosphère de film souvenir.",
    "vionto.visualStyle.polaroid_memory": "Souvenir Polaroid",
    "vionto.visualStyle.polaroid_memory.description": "Tons chauds, vignette douce et traitement d'album photo nostalgique.",
    "vionto.visualStyle.clean_modern_slideshow": "Diaporama moderne épuré",
    "vionto.visualStyle.clean_modern_slideshow.description": "Rendu net, neutre et minimal avec l'apparence par défaut actuelle.",
    "vionto.visualStyle.travel_map_overlay": "Superposition carte de voyage",
    "vionto.visualStyle.travel_map_overlay.description": "Couleur de voyage plus vive avec une grille de carte subtile.",
    "vionto.visualStyle.vhs_archive": "Look VHS/archive",
    "vionto.visualStyle.vhs_archive.description": "Couleur atténuée, bruit analogique et traitement d'archive.",
    "vionto.visualStyle.wedding_cinematic": "Mariage cinématographique",
    "vionto.visualStyle.wedding_cinematic.description": "Contraste cinématographique doux, vignette et typographie élégante.",
    "vionto.visualStyle.social_vertical_captions": "Sous-titres verticaux sociaux",
    "vionto.visualStyle.social_vertical_captions.description": "Cadrage vertical à fort contraste avec sous-titres centrés en gras.",
    ...
    "vionto.projects.description": "Gerez vos projets video. Creez de nouveaux projets, renommez ou supprimez les projets existants, ou partagez-les avec des coequipiers.",
    ...
    "vionto.projects.emptySearchTitle": "Aucun projet ne correspond a votre recherche",
    "vionto.projects.emptyDescription": "Creez votre premier projet pour commencer.",
    "vionto.projects.emptySearchDescription": "Essayez un autre terme de recherche.",
    ...
    "vionto.projects.deleteOutro": "ainsi que toutes ses ressources, scripts et exports. Cette action est irreversible.",
    "vionto.projects.assetWillBeRemoved": "{count} ressource sera supprimee.",
    "vionto.projects.assetsWillBeRemoved": "{count} ressources seront supprimees.",
    ...
    "vionto.projects.sharePending": "{email} n'est pas encore inscrit. L'acces sera active apres inscription.",
    ...
    "vionto.music.libraryEmpty": "Aucune musique dans votre bibliothèque pour l'instant",
    "vionto.music.libraryEmptyHint": "Téléchargez votre premier morceau dans l'onglet Upload.",
    "vionto.music.libraryArtist": "Votre bibliothèque",
    "vionto.music.commonArtist": "Bibliothèque commune",
    "vionto.music.commonBadge": "Partagé",
  ...
  de: {
    ...
    "vionto.visualStyle.film_grain.description": "Texturiertes Korn, weicher Kontrast und Erinnerungsfilm-Atmosphäre.",
    "vionto.visualStyle.polaroid_memory": "Polaroid-Erinnerung",
    "vionto.visualStyle.polaroid_memory.description": "Warme Töne, sanfte Vignette und nostalgischer Fotoalbum-Look.",
    "vionto.visualStyle.clean_modern_slideshow": "Klare moderne Slideshow",
    "vionto.visualStyle.clean_modern_slideshow.description": "Scharfes, neutrales, minimales Rendering mit dem aktuellen Standardlook.",
    "vionto.visualStyle.travel_map_overlay": "Reisekarten-Overlay",
    "vionto.visualStyle.travel_map_overlay.description": "Hellere Reisefarben mit einem subtilen Kartenraster.",
    "vionto.visualStyle.vhs_archive": "VHS/Archiv-Look",
    "vionto.visualStyle.vhs_archive.description": "Gedämpfte Farben, analoges Rauschen und Archivrand-Behandlung.",
    "vionto.visualStyle.wedding_cinematic": "Hochzeit filmisch",
    "vionto.visualStyle.wedding_cinematic.description": "Weicher filmischer Kontrast, Vignette und elegante Untertiteltypografie.",
    "vionto.visualStyle.social_vertical_captions": "Social Vertical Captions",
    "vionto.visualStyle.social_vertical_captions.description": "Kontrastreiches vertikales Framing mit fetten zentrierten Captions.",
    ...
    "vionto.projects.description": "Verwalten Sie Ihre Videoprojekte. Erstellen Sie neue Projekte, benennen oder loeschen Sie bestehende Projekte, oder teilen Sie sie mit Teammitgliedern.",
    "vionto.projects.back": "Zurueck",
    "vionto.projects.createVideo": "Video erstellen",
    "vionto.projects.home": "Startseite",
    "vionto.projects.signInPrompt": "Melden Sie sich an, um Ihre Projekte zu sehen.",
    ...
    "vionto.projects.emptySearchTitle": "Keine Projekte entsprechen Ihrer Suche",
    "vionto.projects.emptyDescription": "Erstellen Sie Ihr erstes Projekt, um zu beginnen.",
    "vionto.projects.emptySearchDescription": "Versuchen Sie einen anderen Suchbegriff.",
    ...
    "vionto.projects.deleteOutro": "und alle Dateien, Skripte und Exporte. Diese Aktion kann nicht rueckgaengig gemacht werden.",
    ...
    "vionto.projects.sharePending": "{email} ist noch nicht registriert. Der Zugriff wird nach der Registrierung aktiviert.",
    ...
    "vionto.music.libraryEmptyHint": "Lade deinen ersten Track im Upload-Tab hoch.",
    "vionto.music.libraryArtist": "Deine Bibliothek",
    "vionto.music.commonArtist": "Gemeinsame Bibliothek",
    "vionto.music.commonBadge": "Geteilt",
