...
export const viontoDictionaries: Dictionaries = {
  en: {
    ...
    "vionto.nav.menu": "Menu",
    "vionto.nav.toggleNavAria": "Toggle navigation",
    ...
    "vionto.aria.albumCollection": "Album collection",
    "vionto.aria.editMetadata": "Edit metadata",
    "vionto.aria.deleteFromProject": "Delete from project",
    "vionto.aria.removeFromAlbum": "Remove from this album",
    "vionto.aria.selectScriptVersion": "Select script version",
    "vionto.aria.deleteClip": "Delete clip",
    ...
    "vionto.album.locationPlaceholder": "e.g., Paris, France",
    "vionto.album.peoplePlaceholder": "Comma-separated names",
    "vionto.album.occasionPlaceholder": "e.g., wedding",
    "vionto.album.moodPlaceholder": "e.g., joyful",
    "vionto.album.editDescriptionPlaceholder": "Album description",
    "vionto.story.openingTitlePlaceholder": "e.g. Our Summer in Provence",
    "vionto.story.introNarrationPlaceholder": "A short intro paragraph to set the scene...",
    "vionto.story.chapterDescriptionPlaceholder": "Description",
    "vionto.story.climaxPlaceholder": "Which moment gets the most emphasis?",
    "vionto.story.closingMessagePlaceholder": "e.g. Until we meet again...",
    "vionto.story.dedicationPlaceholder": "e.g. For Mom and Dad",
    "vionto.subtitle.position.lowerThird": "Lower third",
    "vionto.subtitle.position.top": "Top",
    "vionto.subtitle.position.bottom": "Bottom",
    "vionto.subtitle.position.corner": "Corner",
    "vionto.subtitle.preset.minimal": "Minimal",
    "vionto.subtitle.preset.memory": "Memory",
    ...
    "vionto.album.emptyBase": "No images yet — upload some above.",
    "vionto.album.emptyAlbum": "No images in this album yet.",
    "vionto.project.emailPlaceholder": "colleague@example.com",
    "vionto.confirm.deleteImageTitle": "Delete image",
    "vionto.confirm.removeImageTitle": "Remove image",
    "vionto.confirm.deleteLabel": "Delete",
    "vionto.confirm.removeLabel": "Remove",

    // Visible labels
    "vionto.album.addImages": "Add images",
    "vionto.album.sortByDateShort": "Sort by date",
    "vionto.album.groupByLocationShort": "Group by location",
    "vionto.album.selectImagesFromBase": "Select images to add (from base album)",
    "vionto.album.new": "New album",
  ...
  nl: {
    ...
    "vionto.nav.roadmap": "Roadmap",
    "vionto.nav.menu": "Menu",
    "vionto.nav.toggleNavAria": "Navigatie in-/uitklappen",
    ...
    // Common labels / aria
    "vionto.aria.videoTemplate": "Videotemplate",
    "vionto.aria.albumManagement": "Albumbeheer",
    "vionto.aria.albumCollection": "Albumcollectie",
    "vionto.aria.editMetadata": "Metagegevens bewerken",
    "vionto.aria.deleteFromProject": "Verwijderen uit project",
    "vionto.aria.removeFromAlbum": "Verwijderen uit dit album",
    "vionto.aria.selectScriptVersion": "Scriptversie selecteren",
    "vionto.aria.deleteClip": "Clip verwijderen",
    "vionto.aria.closePreview": "Voorbeeld sluiten",
    "vionto.template.manual": "Handmatig",
    "vionto.template.manualSetup": "Handmatige configuratie",
    "vionto.album.collectionAll": "Alles",
    "vionto.album.namePlaceholder": "Albumnaam",
    "vionto.album.descriptionPlaceholder": "Beschrijving (optioneel)",
    "vionto.album.locationPlaceholder": "bijv. Parijs, Frankrijk",
    "vionto.album.peoplePlaceholder": "Komma-gescheiden namen",
    "vionto.album.occasionPlaceholder": "bijv. bruiloft",
    "vionto.album.moodPlaceholder": "bijv. vrolijk",
    "vionto.album.editDescriptionPlaceholder": "Beschrijving album",
    "vionto.story.openingTitlePlaceholder": "bijv. Onze zomer in Provence",
    "vionto.story.introNarrationPlaceholder": "Een korte introductieparagraaf om de sfeer te zetten...",
    "vionto.story.chapterDescriptionPlaceholder": "Beschrijving",
    "vionto.story.climaxPlaceholder": "Welk moment krijgt de meeste nadruk?",
    "vionto.story.closingMessagePlaceholder": "bijv. Tot we elkaar weer ontmoeten...",
    "vionto.story.dedicationPlaceholder": "bijv. Voor mama en papa",
    "vionto.subtitle.position.lowerThird": "Onderste derde",
    "vionto.subtitle.position.top": "Boven",
    "vionto.subtitle.position.bottom": "Onder",
    "vionto.subtitle.position.corner": "Hoek",
    "vionto.subtitle.preset.minimal": "Minimalistisch",
    "vionto.subtitle.preset.memory": "Herinnering",
    "vionto.subtitle.preset.social": "Sociaal",
    "vionto.subtitle.preset.documentary": "Documentaire",
    "vionto.videoVersion.new": "Nieuwe videoversie",
    "vionto.videoVersion.titleTooltip": "Maak een gloednieuwe videoversie gekoppeld aan dit album",
    "vionto.album.sortByDate": "Sorteer afbeeldingen op EXIF-datum (oudste eerst)",
    "vionto.album.groupByLocation": "Groepeer afbeeldingen op GPS-locatie",
    "vionto.album.collectionsLabel": "Collecties",
    "vionto.album.emptyBase": "Nog geen afbeeldingen — upload er hierboven enkele.",
    "vionto.album.emptyAlbum": "Nog geen afbeeldingen in dit album.",
    "vionto.project.emailPlaceholder": "collega@voorbeeld.nl",
    "vionto.confirm.deleteImageTitle": "Afbeelding verwijderen",
    "vionto.confirm.removeImageTitle": "Afbeelding uit album verwijderen",
    "vionto.confirm.deleteLabel": "Verwijderen",
    "vionto.confirm.removeLabel": "Verwijderen",

    // Visible labels
    "vionto.album.addImages": "Afbeeldingen toevoegen",
    "vionto.album.sortByDateShort": "Sorteren op datum",
    "vionto.album.groupByLocationShort": "Groepeer op locatie",
    "vionto.album.selectImagesFromBase": "Selecteer afbeeldingen om toe te voegen (vanuit het basisalbum)",
    "vionto.album.new": "Nieuw album",
    "vionto.album.manage": "Beheren",
    "vionto.album.done": "Klaar",
  ...
  fr: {
    ...
    "vionto.nav.roadmap": "Feuille de route",
    "vionto.nav.menu": "Menu",
    "vionto.nav.toggleNavAria": "Basculer la navigation",
    ...
    // Common labels / aria
    "vionto.aria.videoTemplate": "Modèle vidéo",
    "vionto.aria.albumManagement": "Gestion des albums",
    "vionto.aria.albumCollection": "Collection d'albums",
    "vionto.aria.editMetadata": "Modifier les métadonnées",
    "vionto.aria.deleteFromProject": "Supprimer du projet",
    "vionto.aria.removeFromAlbum": "Retirer de cet album",
    "vionto.aria.selectScriptVersion": "Sélectionner la version du script",
    "vionto.aria.deleteClip": "Supprimer le clip",
    "vionto.aria.closePreview": "Fermer l'aperçu",
    "vionto.template.manual": "Manuel",
    "vionto.template.manualSetup": "Configuration manuelle",
    "vionto.album.collectionAll": "Tous",
    "vionto.album.namePlaceholder": "Nom de l'album",
    "vionto.album.descriptionPlaceholder": "Description (optionnelle)",
    "vionto.album.locationPlaceholder": "ex. Paris, France",
    "vionto.album.peoplePlaceholder": "Noms séparés par des virgules",
    "vionto.album.occasionPlaceholder": "ex. mariage",
    "vionto.album.moodPlaceholder": "ex. joyeux",
    "vionto.album.editDescriptionPlaceholder": "Description de l'album",
    "vionto.story.openingTitlePlaceholder": "ex. Notre été en Provence",
    "vionto.story.introNarrationPlaceholder": "Un court paragraphe d'introduction pour mettre en scène...",
    "vionto.story.chapterDescriptionPlaceholder": "Description",
    "vionto.story.climaxPlaceholder": "Quel moment est le plus mis en valeur ?",
    "vionto.story.closingMessagePlaceholder": "ex. Jusqu'à notre prochaine rencontre...",
    "vionto.story.dedicationPlaceholder": "ex. Pour maman et papa",
    "vionto.subtitle.position.lowerThird": "Troisième inférieur",
    "vionto.subtitle.position.top": "Haut",
    "vionto.subtitle.position.bottom": "Bas",
    "vionto.subtitle.position.corner": "Coin",
    "vionto.subtitle.preset.minimal": "Minimal",
    "vionto.subtitle.preset.memory": "Souvenir",
    "vionto.subtitle.preset.social": "Social",
    "vionto.subtitle.preset.documentary": "Documentaire",
    "vionto.videoVersion.new": "Nouvelle version vidéo",
    "vionto.videoVersion.titleTooltip": "Créer une toute nouvelle version vidéo liée à cet album",
    "vionto.album.sortByDate": "Trier les images par date EXIF (plus ancien d'abord)",
    "vionto.album.groupByLocation": "Regrouper les images par localisation GPS",
    "vionto.album.collectionsLabel": "Collections",
    "vionto.album.emptyBase": "Pas encore d'images — téléchargez-en ci-dessus.",
    "vionto.album.emptyAlbum": "Pas encore d'images dans cet album.",
    "vionto.project.emailPlaceholder": "collegue@exemple.com",
    "vionto.confirm.deleteImageTitle": "Supprimer l'image",
    "vionto.confirm.removeImageTitle": "Retirer l'image",
    "vionto.confirm.deleteLabel": "Supprimer",
    "vionto.confirm.removeLabel": "Retirer",

    // Visible labels
    "vionto.album.addImages": "Ajouter des images",
    "vionto.album.sortByDateShort": "Trier par date",
    "vionto.album.groupByLocationShort": "Regrouper par localisation",
    "vionto.album.selectImagesFromBase": "Sélectionner des images à ajouter (depuis l'album de base)",
    "vionto.album.new": "Nouvel album",
    "vionto.album.manage": "Gérer",
    "vionto.album.done": "Terminé",
  ...
  de: {
    ...
    "vionto.nav.organizer": "Organizer",
    "vionto.nav.roadmap": "Roadmap",
    "vionto.nav.menu": "Menü",
    "vionto.nav.toggleNavAria": "Navigation umschalten",
    ...
    // Common labels / aria
    "vionto.aria.videoTemplate": "Videovorlage",
    "vionto.aria.albumManagement": "Albenverwaltung",
    "vionto.aria.albumCollection": "Alben-Sammlung",
    "vionto.aria.editMetadata": "Metadaten bearbeiten",
    "vionto.aria.deleteFromProject": "Aus Projekt löschen",
    "vionto.aria.removeFromAlbum": "Aus diesem Album entfernen",
    "vionto.aria.selectScriptVersion": "Scriptversion auswählen",
    "vionto.aria.deleteClip": "Clip löschen",
    "vionto.aria.closePreview": "Vorschau schließen",
    "vionto.template.manual": "Manuell",
    "vionto.template.manualSetup": "Manuelle Einrichtung",
    "vionto.album.collectionAll": "Alle",
    "vionto.album.namePlaceholder": "Albumname",
    "vionto.album.descriptionPlaceholder": "Beschreibung (optional)",
    "vionto.album.locationPlaceholder": "z. B. Paris, Frankreich",
    "vionto.album.peoplePlaceholder": "Durch Kommas getrennte Namen",
    "vionto.album.occasionPlaceholder": "z. B. Hochzeit",
    "vionto.album.moodPlaceholder": "z. B. fröhlich",
    "vionto.album.editDescriptionPlaceholder": "Albumbeschreibung",
    "vionto.story.openingTitlePlaceholder": "z. B. Unser Sommer in der Provence",
    "vionto.story.introNarrationPlaceholder": "Ein kurzer einleitender Absatz, um die Szene zu setzen...",
    "vionto.story.chapterDescriptionPlaceholder": "Beschreibung",
    "vionto.story.climaxPlaceholder": "Welcher Moment wird am stärksten betont?",
    "vionto.story.closingMessagePlaceholder": "z. B. Bis wir uns wiedersehen...",
    "vionto.story.dedicationPlaceholder": "z. B. Für Mama und Papa",
    "vionto.subtitle.position.lowerThird": "Unteres Drittel",
    "vionto.subtitle.position.top": "Oben",
    "vionto.subtitle.position.bottom": "Unten",
    "vionto.subtitle.position.corner": "Ecke",
    "vionto.subtitle.preset.minimal": "Minimal",
    "vionto.subtitle.preset.memory": "Erinnerung",
    "vionto.subtitle.preset.social": "Social",
    "vionto.subtitle.preset.documentary": "Dokumentation",
    "vionto.videoVersion.new": "Neue Videoversion",
    "vionto.videoVersion.titleTooltip": "Erstelle eine brandneue Videoversion, die mit diesem Album verknüpft ist",
    "vionto.album.sortByDate": "Bilder nach EXIF-Datum sortieren (ältestes zuerst)",
    "vionto.album.groupByLocation": "Bilder nach GPS-Standort gruppieren",
    "vionto.album.collectionsLabel": "Sammlungen",
    "vionto.album.emptyBase": "Noch keine Bilder — lade einige oben hoch.",
    "vionto.album.emptyAlbum": "Noch keine Bilder in diesem Album.",
    "vionto.project.emailPlaceholder": "kollege@beispiel.de",
    "vionto.confirm.deleteImageTitle": "Bild löschen",
    "vionto.confirm.removeImageTitle": "Bild entfernen",
    "vionto.confirm.deleteLabel": "Löschen",
    "vionto.confirm.removeLabel": "Entfernen",

    // Visible labels
    "vionto.album.addImages": "Bilder hinzufügen",
    "vionto.album.sortByDateShort": "Nach Datum sortieren",
    "vionto.album.groupByLocationShort": "Nach Standort gruppieren",
    "vionto.album.selectImagesFromBase": "Bilder zum Hinzufügen auswählen (vom Basisalbum)",
