...
export const roadmapItems: RoadmapItem[] = [
  ...
  // TLAI-002..006 each landed backend-only first (API + service layer + eval
  // gate), then got its matching *-UI companion that makes it reachable from
  // the editor — both are "shipped" only once the pair is complete. As of
  // 12 Sep 2026 all five pairs are shipped; TLAI-013 and TLAI-007 onward are
  // what's next.
  {
    id: "TLAI-002",
    title: "Governed AI foundation",
    status: "shipped",
    timeframe: "12 Sep 2026",
    summary:
    ...
    links: [ISSUE(286), PR(322), ISSUE(328), PR(334)],
  },
  {
    id: "TLAI-002-UI",
    ...
    timeframe: "12 Sep 2026",
    summary:
      "Generate, review, accept/reject, and undo AI proposals from inside the editor — the review surface every other AI feature below builds on.",
    tags: ["ai", "ux", "epic #298"],
    links: [ISSUE(328), PR(334)],
  },
  {
    id: "TLAI-013",
  ...
  },
  {
    ...
    links: [ISSUE(287), PR(323), ISSUE(329), PR(335)],
  },
  {
    id: "TLAI-003-UI",
    ...
    timeframe: "12 Sep 2026",
    summary:
      "Paste, upload, or link a source and review extracted events with their citations — or an explicit uncited-inference flag — with per-event accept/reject and a visible re-import indicator, before anything saves.",
    tags: ["ai", "provenance", "ux", "epic #298"],
    links: [ISSUE(329), PR(335)],
  },
  {
    id: "TLAI-004",
    ...
    links: [ISSUE(288), PR(324), ISSUE(330), PR(336)],
  },
  {
    id: "TLAI-004-UI",
    ...
    timeframe: "12 Sep 2026",
    summary:
      "See detected date conflicts with their evidence and each event's date precision, reinterpret an event's date, and leave a conflict unresolved (persisted) when there isn't a confident answer.",
    tags: ["ai", "reasoning", "ux", "epic #298"],
    links: [ISSUE(330), PR(336)],
  },
  {
    id: "TLAI-005",
    ...
    links: [ISSUE(289), PR(325), ISSUE(331), PR(337)],
  },
  {
    id: "TLAI-005-UI",
    ...
    timeframe: "12 Sep 2026",
    summary:
      "Pick an audience, compare concise/standard/immersive variants side by side, see fact-drift/unsupported-claim warnings, and lock events or fields the copilot must never touch — visibly excluded from its own pickers.",
    tags: ["ai", "storytelling", "ux", "epic #298"],
    links: [ISSUE(331), PR(337)],
  },
  {
    id: "TLAI-006",
  ...
  },
  {
    ...
    timeframe: "12 Sep 2026",
    summary:
      "Compare 2-3 accessible visual directions side by side as live mini-previews with plain-English rationale and the heuristic's own inputs, apply one in a click, and undo it in a click.",
