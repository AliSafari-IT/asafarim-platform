  ...
  return (
    <figure style={{ margin: 0 }}>
      ...
      >
        ...
        <text x="80" y="143" textAnchor="middle" fontSize="12" fill="currentColor">Browser</text>

        {/* Reverse proxy */}
        <rect x="200" y="110" width="150" height="56" rx="8" fill="none" stroke="currentColor" strokeWidth="1.5" />
        <text x="275" y="136" textAnchor="middle" fontSize="12" fill="currentColor">Reverse proxy</text>
        <text x="275" y="152" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.7">TLS + subdomain routing</text>

        {/* App */}
        <rect x="410" y="110" width="160" height="56" rx="8" fill="none" stroke="currentColor" strokeWidth="1.5" />
        <text x="490" y="136" textAnchor="middle" fontSize="12" fill="currentColor">Matched app</text>
        <text x="490" y="152" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.7">Next.js, one per product</text>

        {/* Shared DB */}
        <rect x="640" y="30" width="200" height="56" rx="8" fill="none" stroke="var(--accent)" strokeWidth="1.5" />
        <text x="740" y="56" textAnchor="middle" fontSize="12" fill="currentColor">Shared Postgres</text>
        <text x="740" y="72" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.7">Prisma — 7 apps</text>

        {/* Isolated DB */}
        <rect x="640" y="190" width="200" height="56" rx="8" fill="none" stroke="currentColor" strokeWidth="1.5" strokeDasharray="4 3" />
        <text x="740" y="216" textAnchor="middle" fontSize="12" fill="currentColor">Isolated Postgres</text>
        <text x="740" y="232" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.7">Drizzle — testora, appbuilder only</text>

        {/* Arrows */}
        <line x1="140" y1="138" x2="196" y2="138" stroke="currentColor" strokeWidth="1.5" markerEnd="url(#proof-arrow)" />
        <text x="168" y="128" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.75">HTTPS</text>

        <line x1="350" y1="138" x2="406" y2="138" stroke="currentColor" strokeWidth="1.5" markerEnd="url(#proof-arrow)" />
        <text x="378" y="128" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.75">routes</text>
        ...
        <text x="600" y="200" textAnchor="middle" fontSize="10" fill="currentColor" opacity="0.75">isolated apps, never shared</text>
      </svg>
