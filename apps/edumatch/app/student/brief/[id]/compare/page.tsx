          ...
          {items.map((p) => (
            ...
            >
              ...
              <button
                ...
                className="mt-5 w-full rounded-lg bg-[var(--color-primary)] px-5 py-2.5 text-sm font-medium text-[#07101a] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {p.status === "ACCEPTED"
